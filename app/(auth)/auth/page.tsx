...
import auth_video from "@/public/assets/Frame 1707479571.svg";
...
const Page = () => {
  ...
  useEffect(() => {
    const token =
      typeof window !== "undefined" ? Cookies.get("tb_userId") : null;
  ...
  return (
    <div className=" relative bg-white min-h-screen flex items-center justify-center px-4 ">
      ...
      <div className="flex flex-col md:flex-row items-center bg-white rounded-lg  max-w-5xl w-full p-8">
        {/* Left Section */}
        <div className="md:w-1/2 w-full text-center md:text-left space-y-6">
          <div className="flex items-center justify-center md:justify-start gap-2">
            <div className="review rounded-full  p-2">
              <Image
                ...
                width={30}
                height={30}
                className="review rounded-full  w-[30px] h-[30px]"
              />
            </div>
          ...
          <div className="space-y-3">
            <Link
              href="/signup"
              className="block w-full text-center review text-white font-medium py-2 rounded-md hover:bg-teal-600 transition "
            >
              Sign Up →
            </Link>
