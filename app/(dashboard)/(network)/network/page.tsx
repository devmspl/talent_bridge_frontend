...
// //   const { data : res, error : er } = useGetAllUsersQuery({ page_no: 1, page_size: 100 });
// // console.log("API response:", res, er);
...
// const { data, error } = useGetAllUsersQuery({ page_no: 1, page_size: 100 });
...
//                       </p>
//                       <p className="text-xs text-gray-400 leading-tight flex gap-1">
...
//                       {card.placements || "1.3k"} Placements •{" "}
